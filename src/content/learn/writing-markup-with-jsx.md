...
Ten pusty znacznik nazywamy *[fragmentem reactowym](/reference/react/Fragment)*. Fragmenty pozwalają grupować rzeczy bez zostawiania śladu w drzewie HTML przesłanym do przeglądarki.

<DeepDive>

#### Dlaczego musimy opakowywać kilka znaczników JSX-owych? {/*why-do-multiple-jsx-tags-need-to-be-wrapped*/}
...
[Wszystkie te atrybuty znajdziesz w elementach React DOM](/reference/react-dom/components/common). Jeśli zdarzy ci się pomylić, nie martw się - React wyświetli w [konsoli przeglądarki](https://developer.mozilla.org/docs/Tools/Browser_Console) błąd z instrukcją, jak naprawić problem.
